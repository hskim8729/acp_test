<template>
  <div class="pop_in_pop add_factor_standardWork">
    ...
    <div class="popup_content">
      <div class="subtitle_area">
        ...
        <button @click="applyRiskWork">저장</button>
      </div>
...
const emit = defineEmits(["riskFactor_Work"]);
...
//표준추가 팝업 닫기
function applyRiskWork() {
  emit("riskFactor_work", riskFactor);
  popInPopClose();
}
