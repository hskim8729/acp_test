...
<template>
  <div class="popup_content" v-if="majorInfo">
    ...
    <div class="content_box">
      ...
      <div class="item_wrap w100p">
        ...
        <input
          ...
          name="result"
          value="0001"
          :checked="checked(majorInfo.inspRst)"
          disabled
      ...
      <div class="item_wrap w100p">
        ...
        <div class="file">
          <div class="photo" id="actPhotoPreview">
            <!-- <input
              id="acciFile"
              type="file"
              multiple
...
const createFormData = () => {
  ...
  majorInfo.value.inspCls = "T0201"; //중점
...
function checked(target) {
  return target == majorInfo.value.inspRst ? true : false;
}

// 팝업 닫기
function popupClose() {
  document.getElementsByClassName("popup_bg")[0].classList.remove("show");
  document.getElementsByClassName("inpection_appr")[0].classList.remove("show");
}
</script>
