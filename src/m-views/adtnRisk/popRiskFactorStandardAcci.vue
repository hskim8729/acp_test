<template>
  <div class="pop_in_pop add_factor_standardAcci">
    ...
    <div class="popup_content">
      <div class="subtitle_area">
        ...
        <button @click="applyRiskAcci">저장</button>
      </div>
...
const emit = defineEmits(["riskFactor_acci"]);
...
//표준추가 팝업 닫기
function applyRiskAcci() {
  emit("riskFactor_acci", riskFactor);
  popInPopClose();
}
...
// 대분류 클릭 시 중분류 검색
async function selectFetchMdCatList(e, value) {
  ...
  //document.querySelector(".std_sort_step1").style.display = "none";
  //document.querySelector(".std_sort_step2").style.display = "";
  //document.querySelector(".std_sort_step3").style.display = "none";
}
...
async function selectFetchWrkCatList(item, index) {
  ...
  //document.querySelector(".std_sort_step1").style.display = "none";
  //document.querySelector(".std_sort_step2").style.display = "none";
  //document.querySelector(".std_sort_step3").style.display = "";
}
